...
> - **切勿盲目照抄！** 若当前业务模块无特定场景（如：无动态审批、无外部系统交互），请直接 **删除** 对应的选填章节，无需填写“无”或留空以节省精力。
---
...
| 操作节点 | 角色 | 交互动作 | 页面/控件说明 | 反馈提示 |
| :--- | :--- | :--- | :--- | :--- |
| **[节点1-录入]** | [角色A] | 填写表单 | 必填项红色星号，[控件类型]说明 | 实时前端校验，非法字段高亮+提示 |
| **[节点1-提交]** | [角色A] | 点击“提交”按钮 | 提交后按钮置灰，跳转至[列表页] | Toast提示“提交成功” |
| **[节点2-审核/退回]** | [角色B] | 补充信息 + 点击“退回” | 弹出二次确认弹窗+必填原因文本框 | 退回成功后刷新列表，移出待办 |
